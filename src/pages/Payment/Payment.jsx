        ...
        <div className="grid gap-6 sm:grid-cols-2 sm:gap-8 lg:grid-cols-3">
          {packageData.map((item) => {
            return (
              <div
                key={item.id}
                className="flex transform cursor-pointer flex-col justify-between rounded border border-gray-500 px-6 py-4 shadow-card transition-colors duration-300 hover:bg-gray-200 dark:bg-gray-900"
              >
                <div>
