    ...
    <section>
      <div className="container mx-auto">
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
          <div className="flex transform cursor-pointer flex-col justify-between rounded px-6 py-4 shadow-card transition-colors duration-300 hover:bg-gray-200 dark:bg-gray-900 dark:hover:bg-gray-800">
            <div>
